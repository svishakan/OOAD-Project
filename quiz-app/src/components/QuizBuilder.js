...
function QuizBuilder(props) {
    const quizID = props.location.state.qID;
    ...
    const nextQuestion = () => {
        ...
        const incorrect_answers = [document.getElementById("ans2").value, document.getElementById("ans3").value, document.getElementById("ans4").value];

        const record = [questionNumber, question, correct_answer, incorrect_answers];
    ...
    return (
        <form id="quizform" className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-between mt-8">
                ...
                <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" value="Next Question" onClick={nextQuestion} />
                <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" value="Upload Set" onClick={uploadQuiz} />
            </div>
