        ...
        <div>
            ...
            />) : (
                <form id="creatorform" className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <h1 className="block text-gray-700 text-lg text-center font-bold mb-2">Quiz Creator</h1>
                    ...
                    <div className="flex items-center justify-between mt-8">
                        ...
                        <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" value="Set Quiz" onClick={createQuiz} />
                    </div>
                </form>
            )}
